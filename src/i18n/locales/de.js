const de = {
  ...
  addVideo: {
    ...
    bpm: 'BPM (Schläge pro Minute)',
    bpmPlaceholder: 'z.B. 120',
    key: 'Tonart',
  },
  key: {
    notes: {
      C: 'C', Db: 'Des', D: 'D', Eb: 'Es', E: 'E', F: 'F',
      Gb: 'Ges', G: 'G', Ab: 'As', A: 'A', Bb: 'B', B: 'H',
    },
    modes: {
      major: 'Dur', minor: 'Moll', dorian: 'Dorisch', mixolydian: 'Mixolydisch',
    },
  },
  theSession: {
  ...
  comments: {
    ...
    placeholder: 'Teile deine Gedanken zu dieser Melodie…',
    ...
    save: 'Speichern',
    cancel: 'Abbrechen',
    edited: 'Kommentar bearbeitet',
    editError: 'Fehler beim Bearbeiten',
